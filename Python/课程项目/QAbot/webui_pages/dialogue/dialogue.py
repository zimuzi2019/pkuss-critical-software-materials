...
def get_messages_history(history_len: int, content_in_expander: bool = False) -> List[Dict]:    #返回消息历史。
    def filter(msg):
...
def dialogue_page(api: ApiRequest):
    ...
    with st.sidebar:
        ...
        available_models = []
        config_models = api.list_config_models(no_remote_api=True)
    ...
    chat_input_placeholder = "向机器人提问，使用Shift+Enter换行 "
